...
//
//     final jsonFetch = jsonFetchFromJson(jsonString);

import 'dart:convert';

JsonFetch jsonFetchFromJson(String str) => JsonFetch.fromJson(json.decode(str));

String jsonFetchToJson(JsonFetch data) => json.encode(data.toJson());
...
class JsonFetch {
  ...
  factory JsonFetch.fromJson(Map<String, dynamic> json) => JsonFetch(
    total: json["total"],
